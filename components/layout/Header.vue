                    ...
                    <div class="header__pinwheel relative z-[1] w-[1.25rem] h-[2.5rem] overflow-hidden">
                        <span
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 45 45" fill="none"
                                ...
                                style="translate: none; rotate: none; scale: none; transform: translate3d(0px, 0px, 0px) rotate(99.9574deg);">
                                <path logo-fill data-type="pinwheel" fill-rule="evenodd" clip-rule="evenodd" style="fill: #f3f4f6"
                                    d="M26.4277 21.9668C27.3934 21.9063 29.2172 21.1389 31.2274 19.6762C34.8346 17.0516 39.2615 18.5255 42.3768 21.1509C42.9914 21.6099 43.7211 21.9285 44.7819 21.9668H45.0002C44.9478 21.9668 44.8961 21.9674 44.8452 21.9687C44.8961 21.97 44.9478 21.9707 45.0002 21.9707H44.7819C43.7211 22.009 42.9914 22.3275 42.3768 22.7866C39.2615 25.412 34.8346 26.8859 31.2274 24.2613C29.2172 22.7986 27.3934 22.0312 26.4277 21.9707H26.3086C26.3355 21.9707 26.3633 21.97 26.3918 21.9687C26.3633 21.9674 26.3355 21.9668 26.3086 21.9668H26.4277Z"></path>
                                <path logo-fill data-type="pinwheel" fill-rule="evenodd" clip-rule="evenodd" style="fill: #f3f4f6"
                                    d="M18.5723 21.9395C17.6066 21.9999 15.7828 22.7674 13.7726 24.23C10.1654 26.8546 5.73845 25.3808 2.62318 22.7554C2.00863 22.2963 1.27889 21.9777 0.218144 21.9395L-0.000201858 21.9395C0.0522426 21.9395 0.103909 21.9388 0.154822 21.9375C0.103909 21.9362 0.0522426 21.9356 -0.000201858 21.9356L0.218144 21.9356C1.27889 21.8973 2.00863 21.5787 2.62318 21.1196C5.73845 18.4943 10.1654 17.0204 13.7726 19.645C15.7828 21.1076 17.6066 21.8751 18.5723 21.9356L18.6914 21.9356C18.6645 21.9356 18.6367 21.9362 18.6082 21.9375C18.6367 21.9388 18.6645 21.9395 18.6914 21.9395L18.5723 21.9395Z"></path>
                                <path logo-fill data-type="accent" style="fill: #60a5fa"
                                    d="M22.537 19.8393C19.9136 16.7787 16.2408 8.526 22.537 0C25.1603 3.27923 28.8331 11.838 22.537 19.8393Z"></path>
                                <path logo-fill data-type="pinwheel" style="fill: #f3f4f6"
                                    d="M22.5379 44.605C19.9146 41.5443 16.2418 33.2916 22.5379 24.7656C25.1613 28.0449 28.8341 36.6036 22.5379 44.605Z"></path>
                                <path logo-fill data-type="pinwheel" style="fill: #f3f4f6"
                                    d="M27.7842 17.5481C27.8935 14.5422 30.178 8.20232 38.4417 6.89062C38.0044 10.1699 35.2608 16.8923 27.7842 17.5481Z"></path>
                                <path logo-fill data-type="accent" style="fill: #60a5fa"
                                    d="M6.63281 37.3919C6.74212 34.3859 9.02665 28.0461 17.2903 26.7344C16.8531 30.0136 14.1095 36.736 6.63281 37.3919Z"></path>
                                <path logo-fill data-type="pinwheel" style="fill: #f3f4f6"
                                    d="M38.6055 37.3841C38.4962 34.3781 36.2116 28.0383 27.948 26.7266C28.3852 30.0058 31.1288 36.7282 38.6055 37.3841Z"></path>
                                <path logo-fill data-type="pinwheel" style="fill: #f3f4f6"
                                    d="M17.29 17.3841C17.1807 14.3781 14.8962 8.03825 6.63254 6.72656C7.06977 10.0058 9.8134 16.7282 17.29 17.3841Z"></path>
                            </svg>
                        </span>
